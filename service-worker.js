const CACHE='nextmove-sync-v2.0.3-header-sync-checkmark-v7';
const ASSETS=['./','index.html','styles.css','header-sync.css?v=7','app.js?v=7','sync-button.js?v=7','manifest.webmanifest','icons/nextmove-icon.svg','icons/sync-icon.svg'];
