const CACHE='nextmove-sync-v2.0.3-header-sync-confirm';
const ASSETS=['./','index.html','styles.css','header-sync.css','app.js','sync-button.js','manifest.webmanifest','icons/nextmove-icon.svg','icons/sync-icon.svg'];
