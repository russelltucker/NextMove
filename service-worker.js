const CACHE='nextmove-sync-v1.7.1';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icons/nextmove-logo.png','icons/icon-192.png','icons/icon-512.png'];
